...
const (
	...
	AssetPathPSPPermissive                   = "manifests/psp-permissive.yaml"
	AssetPathPSPPermissiveRole               = "manifests/psp-permissive-role.yaml"
	AssetPathPSPPermissiveRoleBinding        = "manifests/psp-permissive-role-binding.yaml"
	AssetPathPSPDefaultPermissive            = "manifests/psp-permissive-default.yaml"
	AssetPathPSPDefaultPermissiveRole        = "manifests/psp-permissive-default-role.yaml"
	AssetPathPSPDefaultPermissiveRoleBinding = "manifests/psp-permissive-default-role-binding.yaml"
	AssetPathPSPCoreDNS                      = "manifests/psp-coredns.yaml"
	AssetPathPSPCoreDNSRole                  = "manifests/psp-coredns-role.yaml"
	AssetPathPSPCoreDNSRoleBinding           = "manifests/psp-coredns-rolebinding.yaml"

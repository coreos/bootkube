...
func newStaticAssets(imageVersions ImageVersions) Assets {
	...
	assets := Assets{
		...
		MustCreateAssetFromTemplate(AssetPathPSPPermissive, internal.PSPPermissive, conf),
		MustCreateAssetFromTemplate(AssetPathPSPPermissiveRole, internal.PSPPermissiveClusterRole, conf),
		MustCreateAssetFromTemplate(AssetPathPSPPermissiveRoleBinding, internal.PSPKubeSystemRoleBinding, conf),
		MustCreateAssetFromTemplate(AssetPathPSPDefaultPermissive, internal.PSPDefaultPermissive, conf),
		MustCreateAssetFromTemplate(AssetPathPSPDefaultPermissiveRole, internal.PSPDefaultPermissiveClusterRole, conf),
		MustCreateAssetFromTemplate(AssetPathPSPDefaultPermissiveRoleBinding, internal.PSPDefaultPermissiveClusterRoleBinding, conf),
		MustCreateAssetFromTemplate(AssetPathPSPCoreDNS, internal.PSPCoreDNS, conf),
		MustCreateAssetFromTemplate(AssetPathPSPCoreDNSRole, internal.PSPCoreDNSRole, conf),
		MustCreateAssetFromTemplate(AssetPathPSPCoreDNSRoleBinding, internal.PSPCoreDNSRoleBinding, conf),
